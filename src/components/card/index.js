...
export default function RecipeReviewCard(props) {
  ...
  /*
        ...
        (The following things are mesured in 100 grams of food quantity)
        cal - Caloric density of food item 
        fat - Amount of fat in food item (in grams)
        sod - Amount of sodium in food item (in mini-grams)
        carbo - Amount of carbohydrate in food item (in grams)
        fibre - Amount of fibre in food item (in grams)
        prot - Amount of protein in food item (in grams)
  */
